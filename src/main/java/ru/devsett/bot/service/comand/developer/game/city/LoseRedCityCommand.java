...
@Component
public class LoseRedCityCommand extends MyCommand {
    ...
    public LoseRedCityCommand(DiscordService discordService, UserService userService, UtilService utilService, WinRateService winRateService) {
    ...
    @Override
    public String help() {
        return "засчитать порожение красным выбранным игрокам, на городской мафии. №-n аргумент - теги игроков";
    }
}
