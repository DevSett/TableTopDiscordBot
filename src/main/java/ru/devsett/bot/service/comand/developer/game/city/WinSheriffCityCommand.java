...
@Component
public class WinSheriffCityCommand extends MyCommand {
    ...
    public WinSheriffCityCommand(DiscordService discordService, UserService userService, UtilService utilService, WinRateService winRateService) {
    ...
    @Override
    public String help() {
        return "засчитать победу выбранным шерифам, на городской мафии. №-n аргумент - теги игроков";
    }
}
