...
@Component
public class WinBlackCityCommand extends MyCommand {
    ...
    public WinBlackCityCommand(DiscordService discordService, UserService userService, UtilService utilService, WinRateService winRateService) {
    ...
    @Override
    public String help() {
        return "засчитать победу черным выбранным игрокам, на городской мафии. №-n аргумент - теги игроков";
    }
}
