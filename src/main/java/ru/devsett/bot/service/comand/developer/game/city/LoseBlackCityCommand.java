...
@Component
public class LoseBlackCityCommand extends MyCommand {
    ...
    public LoseBlackCityCommand(DiscordService discordService, UserService userService, UtilService utilService, WinRateService winRateService) {
    ...
    @Override
    public String help() {
        return "засчитать порожение черным выбранным игрокам, на городской мафии. №-n аргумент - теги игроков";
    }
}
