...
@Component
public class WinRedCityCommand extends MyCommand {
    ...
    public WinRedCityCommand(DiscordService discordService, UserService userService, UtilService utilService, WinRateService winRateService) {
    ...
    @Override
    public String help() {
        return "засчитать победу красным выбранным игрокам, на городской мафии. №-n аргумент - теги игроков";
    }
}
