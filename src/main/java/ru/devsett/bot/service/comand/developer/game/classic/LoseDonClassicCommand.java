...
@Component
public class LoseDonClassicCommand extends MyCommand {
    ...
    public LoseDonClassicCommand(DiscordService discordService, UserService userService, UtilService utilService,
    ...
    public void execute(MessageReceivedEvent event, String command, CommandEvent commandEvent) {
        for (int i = 0; i < splitArgs.length; i++) {
            ...
            if (user == null) {
                ...
                var rate = winRateClassicService.addDonLose(user);
    ...
    @Override
    public String help() {
        return "засчитать порожение выбранным донам, на классической мафии. №-n аргумент - теги игроков";
    }
}
