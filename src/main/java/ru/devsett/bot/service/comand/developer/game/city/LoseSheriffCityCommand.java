...
@Component
public class LoseSheriffCityCommand extends MyCommand {
    ...
    public LoseSheriffCityCommand(DiscordService discordService, UserService userService, UtilService utilService, WinRateService winRateService) {
    ...
    @Override
    public String help() {
        return "засчитать порожение выбранным шерифам, на городской мафии. №-n аргумент - теги игроков";
    }
}
