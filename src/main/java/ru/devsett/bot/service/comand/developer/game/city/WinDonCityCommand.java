...
@Component
public class WinDonCityCommand extends MyCommand {
    ...
    public WinDonCityCommand(DiscordService discordService, UserService userService, UtilService utilService, WinRateService winRateService) {
    ...
    @Override
    public String help() {
        return "засчитать победу выбранным донам, на городской мафии. №-n аргумент - теги игроков";
    }
}
