...
@Component
public class WinBlackClassicCommand extends MyCommand {
    ...
    public WinBlackClassicCommand(DiscordService discordService, UserService userService, UtilService utilService,
    ...
    public void execute(MessageReceivedEvent event, String command, CommandEvent commandEvent) {
      for (int i = 0; i < splitArgs.length; i++) {
            ...
            if (user == null) {
                ...
                var rate = winRateClassicService.addBlackWin(user);
    ...
    @Override
    public String help() {
        return "засчитать победу черным выбранным игрокам, на классической мафии. №-n аргумент - теги игроков";
    }
}
