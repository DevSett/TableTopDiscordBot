...
@Component
public class WinSheriffClassicCommand extends MyCommand {
    ...
    public WinSheriffClassicCommand(DiscordService discordService, UserService userService, UtilService utilService,
    ...
    public void execute(MessageReceivedEvent event, String command, CommandEvent commandEvent) {
        for (int i = 0; i < splitArgs.length; i++) {
            ...
            if (user == null) {
                ...
                var rate = winRateClassicService.addSheriffWin(user);
    ...
    @Override
    public String help() {
        return "засчитать победу выбранным шерифам, на классической мафии. №-n аргумент - теги игроков";
    }
}
